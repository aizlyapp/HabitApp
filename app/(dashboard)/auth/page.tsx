    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-sky-600/20">
            <BedDouble className="h-7 w-7 text-sky-400" />
          </div>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full bg-sky-600 text-white hover:bg-sky-700 h-11"
          >
            {loading ? (
              <>
        ...
        <Button
          ...
          disabled={loading}
          className="w-full border-zinc-700 bg-zinc-800 text-zinc-300 hover:bg-zinc-700 hover:text-white h-11 gap-2"
        >
